...
import os
from network_security.constants import training_pipline
...
class DataIngestionConfig:
    def __init__(self,training_pipline_config:TrainingPipelineConfig):
        ...
        self.train_test_split_ratio = training_pipline.DATA_INGESTION_TRAIN_TEST_SPLIT_RATION
        self.collection_name = training_pipline.DATA_INGESTION_COLLECTION_NAME
        self.database_name = training_pipline.DATA_INGESTION_DATABASE_NAME

class DataValidationConfig:
    def __init__(self,training_pipline_config:TrainingPipelineConfig):
        self.data_validation_dir = os.path.join(
            training_pipline_config.artifact_dir,
            training_pipline.DATA_VALIDATION_DIR_NAME
        )
        self.valid_data_dir = os.path.join(
            self.data_validation_dir,
            training_pipline.DATA_VALIDATION_VALID_DIR
        )
        self.invalid_data_dir = os.path.join(
            self.data_validation_dir,
            training_pipline.DATA_VALIDATION_INVALID_DIR
        )
...
class ModelTrainerConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        self.model_trainer_dir: str = os.path.join( training_pipeline_config.artifact_dir, training_pipline.MODEL_TRAINER_DIR_NAME )
        self.trained_model_file_path: str = os.path.join( self.model_trainer_dir, training_pipline.MODEL_TRAINER_TRAINED_MODEL_DIR,
            training_pipline.MODEL_FILE_NAME,)
        self.expected_score: float = training_pipline.MODEL_TRAINER_EXPECTED_SCORE
        self.overfitting_underfitting_threshold: float = training_pipline.MODEL_TRAINER_OVERFITTING_UNDERFITTING_THRESHOLD